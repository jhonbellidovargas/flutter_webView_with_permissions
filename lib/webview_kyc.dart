...
final webViewKycStateKey = GlobalKey<_WebViewKycState>();

class WebViewKyc extends StatefulWidget {
  const WebViewKyc({
    Key? key, 
  ...
  @override
  State<WebViewKyc> createState() => _WebViewKycState();
}

class _WebViewKycState extends State<WebViewKyc> with WidgetsBindingObserver {
  ...
  InAppWebView _buildWebView() {
    ...
    // initialSettings.allowingReadAccessTo = WebUri(
...
<body>
    ...
    """, baseUrl: errorUrl, historyUrl: errorUrl);
      ...
      //   browserModel.addTab(webViewKyc);
